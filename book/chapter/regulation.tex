...
IRs for whole muscles underlie the concept of fine and gross motor control. Tension is developed by muscle fibers, the number of muscle fibers recruited with each new motor unit recruited influences the size of jumps in active tension. Muscles with lower IRs have greater regulation (control) over the amount of tension they produce. They better accommodate continuous increments in tension with each new motor unit recruited. Of five muscles in Table \ref{table:Innervation_Ratios}, the lateral rectus (eye) and lumbricals (muscle in the hand) have the greatest fine motor control. While the gastrocnemius is responsible for the greatest need for high tension (force) output (gross motor control).
...
\subsubsection{Fast \& Slow $\alpha$-Motor Neurons}
...
\paragraph{A note on motor unit and muscle fiber type}
Fast (larger) and slow (smaller) $\alpha$-motor neurons play a role for motor unit and muscle fiber type. The narrative of this chapter is that there is coherence between the neuron doing the excitation, and the muscle fibers being excited so that they can be activated. The neuron excitations play a causal role in determining the type of muscle fiber \cite{buchthal_motor_1980}. It is not a coincidence that faster and larger motor neurons innervate faster and larger muscle fibers. Studies using electrical stimulation and crossover (changing which neurons innervate which muscles), demonstrate many muscle fiber characteristics change from slow to fast or from fast to slow. These experiments conclude that there is plasticity at the level of muscle fiber type with such manipulations. This plasticity is related to the differences in electrical (not chemical) stimulus. The challenge to anyone wishing to alter their fiber type dominance is finding a way to  tap into the plasticity of the neurons. Certain characteristics such as myosin and myosin ATPase isoforms rely on gene expression (one isoform is expressed or the other is expressed) and therefore may provide a limit to how much, or how many, muscle fibers have this plasticity.
...
\subsubsection{Fast \& Slow Muscle Fibers}
...
These differences result in higher specific tension ($T_s$) in fast muscle fibers. $T_s$ refers to the tension developed per sarcomere or, more commonly considered, tension developed per unit of cross-sectional area. There are more muscle fibers in fast motor units. Which means there are more sarcomeres and a greater cross sectional area. The $T_s$ makes the tension of a motor unit relative to its cross sectional area. When comparing tension of fast vs. slow muscle fibers this allows comparison that avoids the confounding effect of greater cross sectional area.

The molecular (signal transduction) events that lead to the expression of myosin and myosin ATPase isoforms have not yet been completely uncovered. It is assumed that, due to the plasticity of muscle fiber types reported in experimental conditions, at least some muscle fibers retain the ability to express either isoform and that there exists a molecular mechanism that can theoretically be switched \cite{schiaffino_molecular_1996}.
...
Twitch tension refers to the measurable force of a the tension developed during a twitch. Since tetany includes a summation of the twitches, a higher twitch tension results in a higher tetanic tension. Twitch tension is highest in the FF motor units for three reasons. 

\begin{enumerate}
    \item These motor units have the highest number of muscle fibers (N, which is directly related to innervation ratio (IR)).
    \item These motor units have, overall, a higher cross sectional area. Part of the larger cross area, but not all of it, is due to the higher number of fibers. The IR of a FF motor unit is approximately 2x higher than an S motor unit. However, the cross sectional area (A) is approximately 2.3x higher than an S motor unit \cite{bodine_maximal_1987, buchthal_motor_1980}.
    \item These motor units have a slightly higher specific tension ($T_s$). Estimates are that the $T_s$ of FF motor units when tetanized is approximately $22 \ N \cdot cm^{-2}$ compared to S motor units approximately $17 \ N \cdot cm^{-2}$. Based on these estimates the $T_s$ of a FF motor unit is approximately 1.3x that of a S fiber. 
\end{enumerate}
...
\begin{itemize}
    \item $N$ refers to the number of muscle fibers. This is either for one motor unit or can be estimated for an entire muscle by the innervation ratio.\footnotemark\footnotetext{$IR = \frac{N_{mf}}{N_{mu}}$ (Note, when there is one motor unit, $N = IR = N_{mf}$)}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=.75\linewidth]{./figure/Motor_unit_recruitment.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=.65\linewidth]{./figure/MuscleSpindle.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=.75\linewidth]{./figure/EMG_ARV.png}
...
\begin{enumerate}
    \item Based on axon diameter, order alpha motor neurons based on NCV.
    \item Based on the innervation ratios (IRs) identify which muscle is best equipped for fine motor control.
    \item What differences in FG muscle fibers allow faster crossbridge kinetics and higher specific tension (Ts)?
    \item When isolated or when Fast fibers dominate in a muscle the force-velocity curve is shifted in which direction and what does that does this mean for the velocity at a given force, or force at a given velocity?
    \item What does activation of Ia sensor fibers by a quick stretch result in?
\end{enumerate} 