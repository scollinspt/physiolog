...
\chapter{Renal Clearance}\label{chp:renal_clearance}
Updated on \today
\minitoc
...
\begin{enumerate}
    ...
    \item Explain urine formation and excretion by micturition and common causes of incontinence
    ...
    \item Explain renal regulation, and integration of blood volume and osmolarity including the role of renin, angiotensin II, aldosterone and ADH.
    \item Explain the response to positive and negative water balance.
    \item Explain disturbances of fluid volume \& osmolarity.
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=.75\linewidth]{./figure/mass_balance.png}
...
The lining of the GI tract not only absorbs all nutrients (macro and micro), but there is some incidental loss of micro-nutrients (electrolytes and minerals) such as $Ca^{2+}$ in the feces from the GI secretions and normal wear and tear of the cells and tissue that line the GI tract. A small amount of incidental loss of micronutrients such as $Na^+$ and $K^+$ occurs in the sweat and urine. Since the input of these micronutrients can easily exceed the incidental loss, there can be intentional (regulated) loss through the renal filtration and secretion processes to maintain $Na^+$, $K^+$ and $Ca^{2+}$ homeostasis.
...
\begin{backgroundinformation}{Kidney Pain}
...
A unique aspect to renal blood vessels is that they have two sets of arterioles. Blood enters each kidney though the renal artery, which branches until the smallest arteries subdivide into the first set of arterioles, the afferent arterioles. The afferent arterioles function to deliver blood to the glomerular capillaries - a major site of filtration in the nephron. Following filtration blood travels through the second set of arterioles, the efferent arterioles, which deliver blood to the peritubular capillaries, a major site for water and solute reabsorption. Having arterioles before and after the glomerulus equips each nephron with a unique ability to regulate the hydrostatic pressure of the glomerular capillaries, resulting in changes to both renal blood flow and glomerular filtration rate. For example, constriction at either the afferent or efferent end of the glomerulus results in increased vascular resistance and reduced renal blood flow.
To further assist in homeostatic regulation of water-solute balance, the juxtamedullary nephrons have specialized capillary loops called Vasa Recta. These blood vessels travel in a similar form to the Loop of Henle and act as osmotic exchanges, which regulate urine concentration. 
...
\begin{enumerate}
    \item Filtration (indiscriminate elimination): pushing filtrate (plasma) out of the capillary into Bowman's capsule
    \item Reabsorption (selective): selectively pulling substances (including water) back into the capillary
    \item Secretion (selective): selectively pushing substances out of the capillary into the renal tubule
\end{enumerate}
...
\subsection{Urine Formation \& Excretion by Micturition}
...
\begin{backgroundinformation}{Urinary Semantics}
...
\subsubsection{Urinary Incontinence}
...
\section{Filtration-Reabsorption-Secretion}
...
\subsubsection{Factors Influencing Glomerular Filtration}

As with microcirculation there are four pressures for filtration: two hydrostatic pressures and two osmotic pressures. Applying these pressures to glomerular capillaries, there is one small modification because the osmotic pressure of Bowman’s capsule is considered to be zero and therefore is not considered for GFR \cite{costanzo_physiology_2013}. The primary factors that influence GFR include:

\begin{enumerate}
\item Glomerular filtration coefficient
\item Hydrostatic pressure in glomerular capillary
\item Hydrostatic pressure in Bowman’s capsule
\item Osmotic pressure in glomerular capillary
\item Net filtration pressure (nfp)
\end{enumerate} 

\paragraph{Glomerular filtration coefficient}
...
\paragraph{Net filtration pressure}
...
\begin{tabular}{||c || c | c | c||} 
 ...
 \hline\hline
 Renal Disease (renal failure) & $\uparrow$ & $\uparrow$ & Normal \\
 \hline
 $\downarrow$ Renal Blood Flow (hypovolemia, heart failure) & $\uparrow$ $\uparrow$  & $\uparrow$ & $\uparrow$ \\
 \hline
\end{tabular}
\caption{Summary of BUN/Creatinine Ratio}
\label{table:BUN_Creatinine}
\end{table}
...
%and covered in Chapter \ref{chp:digestion_absorption_metabolism} on Digestion, Absorption \& Metabolism.
...
Blood volume is regulated based on two primary factors: 1. impact on BP, RBF and subsequently GFR; 2. impact of water in plasma on ECF osmolarity. These are not completely separate regulatory pathways (there is overlap). The overlap is clear when considering the integration of the hormonal mechanisms underlying the regulation of blood pressure and osmolarity. The primary hormones to be considered include: renin, angiotensin II, anti-diuretic hormone (ADH) and aldosterone. The influence of these three hormones on renal function is summarized in Table \ref{table:Endocrine_Regulation}. How these hormones and renal function is involved in long term blood pressure regulation is covered in Chapter 9 on Circulation. 
...
\begin{tabular}{||c | c | c ||} 
 ...
 \hline\hline
 Renin & $\downarrow$ GFR & $\uparrow$ Angiotensin Converting Enzyme (ACE) \\
 \hline
 Angiotensin II & Angiotensin Converting Enzyme (ACE) & $\uparrow$ Aldosterone; $\uparrow NaCl$ reabsorption, $\uparrow$ GFR \\
 \hline
 Aldosterone & Angiotensin II \& $\uparrow$ plasma $K^+$ concentration & $\uparrow$ $K^+$ secretion, $\uparrow NaCl$ reabsorption \\
 \hline
 Anti-Diuretic Hormone (ADH) & $\uparrow$ plasma osmolarity & $\uparrow$ $H_2O$ reabsorption \\
 \hline
\end{tabular}
\caption{Hormonal Regulation of Renal Function}
\label{table:Endocrine_Regulation}
\end{table}
...
\section{Disturbances in Fluid Volume \& Osmolarity}
...
\begin{equation}
Plasma Osmolarity (mOsm/L) = 2 \times [Na^+] + \frac{[Glucose]}{18} +\frac{[BUN]}{2.8}
\label{osmolarity}
\end{equation}
...
\paragraph{\textbf{Three-Step Approach to Reasoning Through Disturbances in Fluid Volume \& Osmolarity}}
To understand these disturbances, a three-step approach is recommended (\cite{costanzo_physiology_2013}):

\begin{figure}[H]
\begin{center}
    \includegraphics[width=.35\linewidth]{figure/OsM_Disturbances/1osm_steps.png}
\end{center}
 \label{fig:OsM_Disturbances/1osm_steps}
  \caption{Three Step Approach \footnotesize{(Created with Biorender.com by Ashley Ney, SPT, PSU DPT Class of 2025)}}
\end{figure}

\paragraph{\textbf{Six Disturbances: Volume x Osmolarity}}
...
\begin{tabular}{||c | c c||} 
 \hline
Osmolarity & Volume Contraction & Volume Expansion \\ [0.5ex] 
 \hline\hline
Isosmotic  & Diarrhea  & Infusion of NaCl \\
Hyperosmotic & Sweating Lactate &  High NaCl Intake  \\ 
Hyposmotic & Adrenal Insufficiency & SIADH \\[1ex]
 \hline
\end{tabular}
\caption{Volume \& Osmotic Disturbances}
\label{table:OsM_Disturbances}
\end{table}
...
\begin{figure}[H]
\begin{center}
    \includegraphics[width=.75\linewidth]{figure/OsM_Disturbances/2isoOsm_contraction.png}
\end{center}
 \label{fig:OsM_Disturbances/2isoOsm_contraction}
  \caption{Isosmotic Volume Contraction \footnotesize{(Created with Biorender.com by Ashley Ney, SPT, PSU DPT Class of 2025)}}
\end{figure}
...
\begin{figure}[H]
\begin{center}
    \includegraphics[width=0.6\linewidth]{figure/OsM_Disturbances/3hyperOsm_contraction.png}
\end{center}
 \label{fig:OsM_Disturbances/3hyperOsm_contraction}
 \caption{Hyperosmotic Volume Contraction \footnotesize{(Created with Biorender.com by Ashley Ney, SPT, PSU DPT Class of 2025)}}
\end{figure}
...
\begin{figure}[H]
\begin{center}
    \includegraphics[width=0.75\linewidth]{figure/OsM_Disturbances/4hypoOsm_contraction.png}
\end{center}
 \label{fig:OsM_Disturbances/4hypoOsm_contraction}
 \caption{Hyposmotic Volume Contraction \footnotesize{(Created with Biorender.com by Ashley Ney, SPT, PSU DPT Class of 2025)}}
\end{figure}
...
\begin{figure}[H]
\begin{center}
    \includegraphics[width=0.75\linewidth]{figure/OsM_Disturbances/5isoOsm_expansion.png}
\end{center}
 \label{fig:OsM_Disturbances/5isoOsm_expansion}
 \caption{Isosmotic Volume Expansion \footnotesize{(Created with Biorender.com by Ashley Ney, SPT, PSU DPT Class of 2025)}}
\end{figure}
...
\begin{figure}[H]
\begin{center}
    \includegraphics[width=0.75\linewidth]{figure/OsM_Disturbances/6hyperOsm_expansion.png}
\end{center}
 \label{fig:OsM_Disturbances/6hyperOsm_expansion}
 \caption{Hyperosmotic Volume Expansion \footnotesize{(Created with Biorender.com by Ashley Ney, SPT, PSU DPT Class of 2025)}}
\end{figure}
...
\begin{figure}[H]
\begin{center}
    \includegraphics[width=0.75\linewidth]{figure/OsM_Disturbances/7hypoOsom_expansion.png}
\end{center}
 \label{fig:OsM_Disturbances/7hypoOsom_expansion}
 \caption{Hyposmotic Volume Expansion \footnotesize{(Created with Biorender.com by Ashley Ney, SPT, PSU DPT Class of 2025)}}
\end{figure}

%\newpage
\subsection{Summary of Disturbances in Fluid Volume \& Osmolarity}


\begin{figure}[H]
    \centering
    \includegraphics[width=.85\linewidth]{figure/OsM_Disturbances/OsM_Disturbances_Overview.png}
    \caption{Overview of Osmotic Disturbances \footnotesize{(Created with Biorender.com by Ashley Ney, SPT, PSU DPT Class of 2025)}}
    \label{fig:OsM_Disturbances_Overview}
\end{figure}
...
\begin{enumerate}
    \item What are the functions of the kidneys for maintaining acid base balance?
    \item Diuretics work by increasing urine formation in the kidney's. Some diuretics (Aldosterone antagonists and Sodium channel blockers) are called potassium sparing diuretics because they decrease K+ secretion. What are possible consequences of diuretics that are NOT potassium sparing?
    \item What happens during Hyposmotic Volume Expansion?
    \item What happens during negative water balance (Water Balance = Water Intake - Water Loss)?
    \item What happens without any tubular reabsorption to the mass balance of essential nutrients such as glucose and electrolytes such as sodium?
    \item What are possible causes of a large increase in the BUN but only a small increase in Creatinine so that the BUN/Creatinine ratio increases? 
\end{enumerate} 